...
DESCRIPTION: reads all line in multiple defect files and Tokenises each line and stores the information
of defects in and array defect_arr which is of type defect struct.
*/
